...
class FunctorHandler : public FunctorImpl <typename ParentFunctor::ResultType, typename ParentFunctor::ParmList>
{
    ...
    ResultType operator()(typename ParentFunctor::Parm1 p1,typename ParentFunctor::ParmList::Parm2 p2){
        return fun_(p1,p2); 
    }
    ResultType operator()(typename ParentFunctor::Parm1 p1,typename ParentFunctor::ParmList::Parm2 p2,typename ParentFunctor::ParmList::Parm3 p3){
